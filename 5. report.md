...
|        Frempong Emmanuel         |  01243639B  |Algorithm Writer       |
...
|         Salisu Ibrahim           |  01243769B  |Documention Lead       |
...
## 3. Problem Statement
In many practical classes, student scores are recorded in notebooks or spreadsheets. This can 
lead to calculation errors, misplaced records, and delays in producing performance 
summaries.

There is a need for a simple C++ application that allows a lecturer or class representative to 
enter student names and practical scores, calculate average performance, assign remarks, 
and save the final report into a text file.
...
### Aim
The aim of this project is to develop a C++ Student Practical Score Management System that 
records practical scores, calculates performance statistics, assigns remarks, and saves the 
score report for academic use.
